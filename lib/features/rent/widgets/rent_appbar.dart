...
import 'package:renter_pay/features/rent/widgets/filter.dart';
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Center(
              child: Image.asset(IconsPath.favorite, height: 15.h, width: 17.w),
            ),
          ),
        ),
        SizedBox(width: 8.w),
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(width: 0.88.sp, color: AppColors.primaryBorder),
              boxShadow: [
                BoxShadow(
