...
class InspectionFaq extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    InspectionFormController inspectionFromController = Get.find();
      ...
      itemBuilder: (context, index) {
        return Obx(() {
          return CustomFaq(
            ...
            subtitle: inspectionFromController.isShowFAQ[index]
                ? ""
                : inspectionFromController.faqList[index]['subtitle'],
            onTap: () {
              HitTestBehavior.opaque;
              inspectionFromController.isShowFAQ[index] =
                  !inspectionFromController.isShowFAQ[index];
            },
