    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 8.h,),
          CustomTextSecondary(text: 'Submit a new support or maintenance request using the form.',fontSize: 12.sp,fontWeight: FontWeight.w400,),
          SizedBox(height: 20.h,),
          CreateTicketField(),
          CustomAttachedImage(imageList: supportController.uploadImage),
          SizedBox(height: 20.h,),
          CustomPrimaryButton(
            height: 48.h,
            text: 'Submit Ticket',
