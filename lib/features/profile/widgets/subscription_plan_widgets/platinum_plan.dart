...
class PlatinumPlan extends StatelessWidget {
  ...
  const PlatinumPlan({super.key, this.purchaseButton});
  ...
  Widget build(BuildContext context) {
    return SubscriptionContainer(
      ...
      widgetList: [
        BenefitsList(
          listText: "List up to 10 properties (more than 3\nallowed)",
          fontSize: 14.sp,
        ),
        ...
        SizedBox(height: 12.h),
        BenefitsList(
          listText: "36 hours free legal advice (tenancies\nor sale)",
          fontSize: 14.sp,
        ),
        SizedBox(height: 12.h),
        BenefitsList(
          listText: "Dedicated agent assigned (professional\nhelp)",
          fontSize: 14.sp,
        ),
        SizedBox(height: 12.h),
      ],
