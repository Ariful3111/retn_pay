...
class ApplicationManagementDetailsPartDField extends GetWidget<ApplicationManagementDetailsController> {
  final String label;
  const ApplicationManagementDetailsPartDField({super.key, required this.label});
  @override
