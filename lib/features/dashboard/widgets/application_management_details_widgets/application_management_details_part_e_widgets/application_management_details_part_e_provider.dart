...
class ApplicationManagementDetailsPartEProvider extends GetWidget<ApplicationManagementDetailsPartEController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ApplicationManagementDetailsPartEHelper().sectionTitle('4. Previous rental provider/agent details', isDark),
