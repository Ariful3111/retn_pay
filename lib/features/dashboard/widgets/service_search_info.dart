...
class ServiceSearchInfo extends StatelessWidget {
  const ServiceSearchInfo({super.key});

  @override
  Widget build(BuildContext context) {
    bool isDark = Theme.of(context).brightness == Brightness.dark;
    ServiceSearchController searchController = Get.find();
        ...
        children: [
            ...
            children: [
              ...
              Obx(
                () => ServiceDetailsSwitcher(
                  isShow: searchController.isShowInfo.value,
                  onTap: () {
                    searchController.isShowInfo.value =
                        !searchController.isShowInfo.value;
                  },
                ),
              ),
          ...
          Obx(() {
            return AnimatedSwitcher(
              ...
              child: searchController.isShowInfo.value
                  ? CustomTextSecondary(
                      text:
