class ServiceListModel {
  ...
  ServiceListModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? ServiceListData.fromJson(json['data']) : null;
    errors = json['errors'];
  }
...
class ServiceListData {
  ...
  ServiceListData({this.data, this.links, this.meta});
...
class ServiceItem {
  ...
  String? experience;
  String? supportTime;
  List<ServiceWhyChooseUs>? whyChooseUs;
  ...
  ServiceItem.fromJson(Map<String, dynamic> json) {
    ...
    if (json['why_choose_us'] != null) {
      ...
      json['why_choose_us'].forEach((v) {
        whyChooseUs!.add(ServiceWhyChooseUs.fromJson(v));
      });
    }
...
class ServiceWhyChooseUs {
  String? icon;
  String? title;
  String? shortDescription;

  ServiceWhyChooseUs({this.icon, this.title, this.shortDescription});

  ServiceWhyChooseUs.fromJson(Map<String, dynamic> json) {
    icon = json['icon'];
    title = json['title'];
