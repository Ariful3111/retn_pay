...
class VilaList extends StatelessWidget {
  ...
  const VilaList({super.key, required this.homeController});

  @override
  Widget build(BuildContext context) {
    return homeController.vilaProperties.isEmpty
        ? SizedBox()
        : Column(
            children: [
              applyPadding(
                widget: Category(categoryName: 'Villa', categorySlug: 'villa'),
              ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  shrinkWrap: true,
                  itemCount: homeController.vilaProperties.length,
                  scrollDirection: Axis.horizontal,
                  itemBuilder: (_, index) {
                    Property property = homeController.vilaProperties[index];
                    bool isFirst = index == 0;
                    bool isLast =
                        index == homeController.vilaProperties.length - 1;
