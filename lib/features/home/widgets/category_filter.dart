...
import 'package:renter_pay/shared/widgets/filter/category_custom_filter.dart';
import 'package:syncfusion_flutter_sliders/sliders.dart';

class CategoryFilter extends StatelessWidget {
  final PropertyAddressController propertyAddressController;
  const CategoryFilter({super.key, required this.propertyAddressController});
