...
class MainHomeController extends GetxController {
  ...
  final List<Map<String, dynamic>> navItems = [
    {
      'icon': userIndex == 1 || userIndex == 2 || userIndex == 3
          ? IconsPath.dashboard
          : IconsPath.home,
      'label': userIndex == 1 || userIndex == 2 || userIndex == 3
          ? 'Dashboard'
          : 'Home',
      'isColor': true,
    },
    {
      'icon': userIndex == 3 ? IconsPath.drawerBook : IconsPath.rent,
      'label': userIndex == 3 ? 'Booking' : 'Rent',
      'isColor': true,
    },
    {
      'icon': userIndex == 1 || userIndex == 2 || userIndex == 3
    ...
    {
      'icon':
          Get.find<ProfileController>().profileData.value?.data?.image ?? '',
      'label': 'Profile',
      'isColor': false,
    },
  ];
